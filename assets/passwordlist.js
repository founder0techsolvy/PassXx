...
function displayPassword(data) {
    ...
    const decryptedPrimaryPassword = decryptPassword(data.primaryPassword, secretKey)

    const decryptedSecondaryPassword = decryptPassword(data.secondaryPassword, secretKey)
    ...
    passwordEntry.innerHTML = `
        ...
        <div class="password">
            ...
            <input type="password" value="${decryptedPrimaryPassword}" disabled>
        ...
        <div class="password">
            ...
            <input type="password" value="${decryptedSecondaryPassword}" disabled>
